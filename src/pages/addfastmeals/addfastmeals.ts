...
/**
 * Generated class for the AddfastmealsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-addfastmeals',
  templateUrl: 'addfastmeals.html',
})
export class AddfastmealsPage {
  ...
  ionViewDidLoad() {
    ...
    addfod(name,price,des){
      ...
      if(name.length > 0 && price.length > 0 && des.length > 0 && this.imageurl.length > 0){
        ...
        this.db.list("fods/fastmeals").push({
          name:name,
          price:price,
          des:des,
          image:this.imageurl,
