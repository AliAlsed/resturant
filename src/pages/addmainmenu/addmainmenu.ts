...
/**
 * Generated class for the AddmainmenuPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-addmainmenu',
  templateUrl: 'addmainmenu.html',
})
export class AddmainmenuPage {
  imageurl = "";
  imagecheck= false;
