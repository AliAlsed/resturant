...
/**
 * Generated class for the AddfastJuicesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-addfast-juices',
  templateUrl: 'addfast-juices.html',
})
export class AddfastJuicesPage {
  imageurl = "";
  imagecheck= false;
